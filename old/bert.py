...
class BERT(nn.Module):
    ...
    def forward(self, input_ids, segment_ids, masked_pos):
        ...
        # print('HIII')
        # print(masked_pos) # I'm just the masked word id's arrays per sample sentences
        masked_pos = masked_pos[:, :, None].expand(-1, -1, output.size(-1)) # [batch_size, max_pred, d_model]
        # get masked position from final output of transformer.
        # print(masked_pos.shape)
        # print(masked_pos) # now I turned each number from masked_pos and changed it to a 768 long array of the number repeating
        ...
        # print(logits_lm)
        # logits lm is      batch_size x len of masked words arr (max_pred) x probs of each vocab word being at the masked position
...
def main():
    ...
    # print(input_ids.shape, masked_tokens.shape, masked_pos.shape)
